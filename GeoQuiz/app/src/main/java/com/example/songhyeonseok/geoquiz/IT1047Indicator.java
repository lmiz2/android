...
public class IT1047Indicator extends LinearLayout{
    ...
    public IT1047Indicator(Context context) {
        super(context);

        mContext = context;
    }

    public IT1047Indicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
     ...
     */
    public void createDotPanel(int count , int defaultCircle , int selectCircle, OnClickListener listener) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            imageDot[i].setTransitionName(i+"");
            imageDot[i].setOnClickListener(listener);
        }
